...
export default async function CompanyDetailPage({ params }: CompanyDetailPageProps) {
  ...
  // Parallel fetch: company with relations, recent activities, and associated deals
  ...
  return (
    <div>
      ...
      <div className="space-y-6">
        {/* Company detail card with tags, size, contact info */}
        <CompanyDetailCard company={company} />

        {/* Tabbed navigation: overview, contacts, deals, activities */}
