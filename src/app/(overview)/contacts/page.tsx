...
export default async function ContactsPage({ searchParams }: ContactsPageProps) {
  ...
  // Build Prisma where clause — supports search across name/email/phone/title, filter by company/authority/decision-maker
  const where = {
  ...
  // Parallel fetch: paginated contacts with company, tags, and relation counts
